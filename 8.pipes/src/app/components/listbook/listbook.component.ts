...
@Component({
    ...
    imports: [CommonModule, FormsModule, FilterPipe, PriceFilter]
})
export class ListbookComponent {
  ...
  isEditting: boolean;
  edittedBook!: Book;
  $bookList : Observable<Book[]> | null = null;
  $startBookList : Observable<Book[]>;
  ...
  constructor(bookService: BookdaoService) {
    ...
    this.$startBookList = bookService.getAll();
